...
def get_data(filters):
	accounts = frappe.db.sql("""select name, parent_account, account_name,account_name_in_arabic, root_type, report_type, lft, rgt
...
def calculate_values(accounts, gl_entries_by_account, opening_balances, filters, company_currency):
	...
	total_row = {
		...
		"account_name_in_arabic": "'" + _("Total") + "'",
...
def prepare_data(accounts, filters, total_row, parent_children_map, company_currency):
	...
	for d in accounts:
		...
		row = {
			...
			"account_name_in_arabic": d.account_name_in_arabic,
			"account": d.name,
...
def get_columns():
	return [
		...
		{
			"fieldname": "account_name_in_arabic",
			"label": _("Account in Arabic"),
			"fieldtype": "Link",
			"options": "Account",
			"width": 300
		},
