...
frappe.ui.form.on("Payment Reconciliation Multicurrency Payment", {
...
erpnext.accounts.PaymentReconciliationMulticurrencyController = frappe.ui.form.Controller.extend({
	onload: function() {
		var me = this;
	...
	set_invoice_options: function() {
		...
		if (invoices) {
			frappe.meta.get_docfield("Payment Reconciliation Multicurrency Payment", "invoice_number",
...
$.extend(cur_frm.cscript, new erpnext.accounts.PaymentReconciliationMulticurrencyController({frm: cur_frm}));
