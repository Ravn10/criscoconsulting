...
from criscoconsulting.common_code import cancel_payment_entry,create_payment_entry,delete_payment_entry,separate_name
...
class EntryofReceipt(AccountsController):
	...
	# 	# frappe.throw("cancel entry")
	# 	cancel_payment_entry(self)
	
	# def after_delete(self):
	# 	# frappe.msgprint("delete entry")
    ...
    def clear_unallocated_reference_document_rows(self):
        ...
        frappe.db.sql("""delete from `tabEntry Of Receipt Reference`
