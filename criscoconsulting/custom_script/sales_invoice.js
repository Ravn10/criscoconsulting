frappe.ui.form.on('Sales Invoice', {
	...
	customer: function(){
		...
		if(cust == "CASH SALES-AL KHOBAR"||"CASH SALES-JEDDAH-K5"||"CASH SALES - RIYADH"){
			cur_frm.set_df_property("cash_customer_name","reqd",0)
			cur_frm.set_df_property("cash_customer_address","reqd",0)
			cur_frm.set_df_property("cash_customer_vat_no","reqd",0)
			cur_frm.set_df_property("cash_customer_name_in_arabic","reqd",0)
			cur_frm.set_df_property("cash_customer_contact_number","reqd",0)
		}else{
			cur_frm.set_df_property("cash_customer_name","reqd",0)
			cur_frm.set_df_property("cash_customer_address","reqd",0)
			cur_frm.set_df_property("cash_customer_vat_no","reqd",0)
